<section>
    <div class = "row">
        <div class = "col-xl-6 col-xs-12">
            ...
            <div class = "container">
                <h3 class  = "font-just-me color-iscz-red"><?php echo __('pages/ceremonies/preparation.content.sections.before_ceremony.body.healthy_foods.title'); ?></h3>
                <p>
                    <?php echo __('pages/ceremonies/preparation.content.sections.before_ceremony.body.healthy_foods.par'); ?>
                </p>
            </div>
        </div>
