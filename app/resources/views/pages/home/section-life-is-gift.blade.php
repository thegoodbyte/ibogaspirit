<section id = "home-zijte-stastne">
    ...
    <div class = "row">
        <div class = "col-xl-6 ">
            <h2 class="p-3">POZNEJTE <br />SVÉ PRAVÉ JÁ ...</h2>
            <p class  = "p-3">
        ...
        <div class = "col-xl-6 p-3">
            <h2 class="">IBOGA MEDICÍNA</h2>
            <div class="menu-iboga-container">

                <div class=""><a href="/iboga/co-je-iboga" class="">Co je IBOGA MEDICÍNA</a></div>
                <div class=""><a href="/iboga/jak-vam-iboga-muze-pomoci" class="">Jak vám Iboga může pomoci</a></div>
                <div class=""><a href="/iboga/bwiti-tradice" class="">Bwiti Tradice</a></div>
                <div class=""><a href="/iboga/iboga-vs-ayahuasca" class="">Iboga vs Ayahuasca</a></div>
                <div class=""><a href="/obrady/priprava" class="">Příprava a Průběžná péče</a></div>
                ...
                <div class="">
                    <a href="/obrady/prvni-ceremonial-a-co-ocekavat"
                       class="jet-custom-nav__item-link">VÁŠ PRVNÍ IBOGA CEREMONIÁL</a>
                </div>
