...
@section('content')
    ...
    <div class = "row">
        <h1 class = "h1-heading font-just-me color-iscz-red">Iboga Medicína</h1>
    ...
    <div class = "row">
        ...
        <div class = "col-xl-6">
            ...
            <p class="text-justify">Malý keř, který divoce roste po celém Gabonu a Kamerunu, Tabernanthe Iboga obvykle dorůstá do
                výšky sedmi stop (2.1 metru) . Za optimálních podmínek může rostlina dospět v malý strom vysoký až 30 stop. Tento strom se zářivě
                zelenými listy vytváří shluky drobných bílých a žlutých květů a oranžově zbarvené, oválné ovoce Iboga.</p>
    ...
    <div class = "row">
        ...
        <div class = "col-xl-6">
            ...
            <p class="text-justify">Naše rány mohly být zneužíváním v emocionální, mentální, sexuální nebo fyzické
                formě nebo těžkým zármutkem či ztrátou. Možná jsme byli zapojeni do traumatického incidentu nebo
                jsme byli jeho svědky. Mohou nás ovlivnit jako děti, mládež, dospělé nebo v různých obdobích našeho života.</p>

            <p class="text-justify">Postupem času se tyto zkušenosti otisknou do našeho podvědomí a vytvoří podmínky
            ...
            <p class="text-justify">Tyto blokády se projevují jako strach, nejistota, deprese, úzkost, odpojení od
                sebe a zdroje, vysilující emoce, děsivé vzpomínky nebo pocity neustálého strachu. V podstatě byla
                naše mysl unesena a my se stáváme vězněm a naše myšlenky přebírají kontrolu nad našimi životy.</p>

            <p class="text-justify">S myslí běžící show vstupujeme do začarovaného, ​​opakujícího se cyklu
                ...
                mysl a že si zasloužíme milovat sami sebe.</p>
        </div>
    </div>
